...
**The Problem:** Solo travel in India suffers from "Scam Fatigue," safety anxiety, and cost inefficiency. Traditional social networks fail because they lack accountability and verify nothing.
**The Solution:** An Agentic Social Shield that coordinates high-trust, shared experiences using real-time geofencing and zero-tolerance identity checks.
...
## 3. The 4 Pillars of Radical Candor (Manifesto)
1.  **Respect the RSVP:** Enforced via the Anti-Ghosting Penalty.
2.  **Default to Transparency:** NLP Sentiment Sentinels ensure platonic, non-predatory intent.
3.  **Leave Nobody Behind:** Empty seats are open to the verified network (Table/Cab share) via Auto-Split.
4.  **Protect the Sanctuary:** Meetups are gated to verified Safe-Hubs.

## 4. MVP Launch Strategy (First 90 Days)
**Target Metric:** 95% Reliability Rate on the first 100 Handshakes. S2H (Serendipity-to-Handshake) latency.
**Pilot Corridor:** High-Friction Hub (Varanasi/Udaipur).

*   **Month 1 (Identity):** Aadhaar-Lite integration (Zoop/HyperVerge) and Yaar-Score backend.
*   **Month 2 (The Agent):** Implement GeoPulse tracking and the Proactive Proposal UI (React).
